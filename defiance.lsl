...
<Layout version="1.6.1">
  ...
  <VerticalHeight>323</VerticalHeight>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\Duriel\Desktop\speedrun resources\autosplit\defiance5.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>False</Split>
        <CustomSettings>
          <Setting id="split0" type="bool">False</Setting>
          <Setting id="split1" type="bool">False</Setting>
          <Setting id="split2" type="bool">False</Setting>
          <Setting id="split3" type="bool">False</Setting>
          <Setting id="split4" type="bool">False</Setting>
          <Setting id="split5" type="bool">False</Setting>
          <Setting id="split6" type="bool">False</Setting>
          <Setting id="split7" type="bool">False</Setting>
          <Setting id="bossdead" type="bool">False</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
